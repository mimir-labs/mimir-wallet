...
export const devEndpoints: Endpoint[] = [
  {
    ...
    socketUrl: 'ws://dev-api.mimir.global/',
...
export const testnetEndpoints: Endpoint[] = [
  {
    ...
    socketUrl: 'ws://rococo-api.mimir.global/',
...
export const polkadotEndpoints: Endpoint[] = [
  {
    ...
    socketUrl: 'ws://polkadot-api.mimir.global/',
  ...
  },
  {
    ...
    socketUrl: 'ws://assethub-polkadot-api.mimir.global/',
...
export const kusamaEndpoints: Endpoint[] = [
  {
    ...
    socketUrl: 'ws://kusama-api.mimir.global/',
...
export const paseoEndpoints: Endpoint[] = [
  {
    ...
    socketUrl: 'ws://paseo-api.mimir.global/'
  }
];
