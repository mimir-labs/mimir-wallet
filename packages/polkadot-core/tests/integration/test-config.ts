...
export const TEST_CONFIG = {
  paseo: {
    ...
    genesisHash: '0x77afd6190f1554ad45fd0d31aee62aacc33c6db0ea801129acb813f913e0764f' as HexString,
    ss58Format: 0,
    nativeDecimals: 10,
    nativeToken: 'PAS',
    supportsDryRun: true,
...
export const TEST_ADDRESSES = {
  ...
  aliceHex: '0xd43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d' as HexString,

  // Bob - standard dev account
  bob: '5FHneW46xGXgs5mUiveU4sbTyGBzmstUspZC92UhjJM694ty',
  bobHex: '0x8eaf04151687736326c9fea17e25fc5287613693c912909cb226aa4794f26a48' as HexString,

  // Charlie - standard dev account
  charlie: '5FLSigC9HGRKVhB9FiEo4Y3koPsNmBmLJbpXg2mp1hXcS59Y',
  charlieHex: '0x90b5ab205c6974c9ea841be688864633dc9ca8a357843eeacf2314649965fe22' as HexString,
