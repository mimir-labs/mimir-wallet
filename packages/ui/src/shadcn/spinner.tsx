...
type SpinnerColor = 'current' | 'primary';
...
function resolveSize(size: SpinnerSize | undefined): number {
...
function getColorClass(color: SpinnerColor | undefined): string {
  return color === 'current' ? 'text-current' : 'text-primary';
}

type SpinnerVariantProps = Omit<SpinnerProps, 'variant' | 'label' | 'color'>;
...
export const Spinner = ({ variant = 'circle', size, color, label, className, ...props }: SpinnerProps) => {
  ...
  const spinnerElement = (() => {
    switch (variant) {
      case 'circle':
        return <Circle className={cn(colorClass, className)} size={resolvedSize} {...props} />;
      case 'pinwheel':
        return <Pinwheel className={cn(colorClass, className)} size={resolvedSize} {...props} />;
      case 'circle-filled':
        return <CircleFilled className={cn(colorClass, className)} size={resolvedSize} {...props} />;
      case 'ellipsis':
        return <Ellipsis className={cn(colorClass, className)} size={resolvedSize} {...props} />;
      case 'ring':
        return <Ring className={cn(colorClass, className)} size={resolvedSize} {...props} />;
      case 'bars':
        return <Bars className={cn(colorClass, className)} size={resolvedSize} {...props} />;
      case 'infinite':
        return <Infinite className={cn(colorClass, className)} size={resolvedSize} {...props} />;
      default:
        return <Default className={cn(colorClass, className)} size={resolvedSize} {...props} />;
    }
  })();
...
export const buttonSpinner = <Spinner className='button-spinner' color='current' size='sm' />;
