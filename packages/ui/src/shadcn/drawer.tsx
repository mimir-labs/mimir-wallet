...
function DrawerOverlay({ className, children, ...props }: React.ComponentProps<typeof DrawerPrimitive.Overlay>) {
  return (
  ...
  return (
    <DrawerPortal data-slot='drawer-portal'>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          'group/drawer-content bg-background border-divider fixed z-50 flex h-auto flex-col backdrop-blur-md backdrop-saturate-150',
        ...
        {...props}
      >
        <div className='bg-divider mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block' />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
