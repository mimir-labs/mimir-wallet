...
import ImgTxFailed from '@/assets/images/tx-failed.png';
import ImgTxPending from '@/assets/images/tx-pending.png';
import ImgTxSuccess from '@/assets/images/tx-success.png';
