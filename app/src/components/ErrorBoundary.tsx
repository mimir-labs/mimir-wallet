...
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  override render(): ReactNode {
    if (this.state.hasError) {
      ...
      return (
        this.props.fallback || (
          <div className="bg-background border-divider relative w-full max-w-3xl overflow-hidden rounded-[20px] border shadow-md">
            ...
            <div className="border-divider relative border-b p-4 pb-6">
              ...
              <p className="text-foreground/80 mt-2">
                The application encountered an unexpected error({errorName})
              </p>
            </div>
            ...
            <div className="relative p-4">
              <div className="space-y-4">
                ...
                <div className="border-divider overflow-hidden rounded-lg border">
                  ...
                  <div className="bg-background rounded-b-lg px-4 py-3">
                    <div className="text-danger font-mono text-xs break-words whitespace-pre-wrap">
                      {errorMessage}
                    </div>
                  </div>
                </div>
