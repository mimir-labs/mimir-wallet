...
import { Link, Modal, ModalBody, ModalContent, ModalHeader } from '@mimir-wallet/ui';
  ...
  return (
    <Modal size='2xl' isOpen={open} onClose={onClose} autoFocus>
      <ModalContent>
        ...
        <ModalBody className='flex flex-col sm:flex-row gap-4 sm:gap-5 pb-5'>
          <Link
