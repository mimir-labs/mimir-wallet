...
function Item({
  ...
  return (
    <div
      key={id}
      className="bg-primary/5 flex items-center gap-2.5 rounded-[10px] p-4"
    >
      <label className="inline-flex cursor-pointer items-center gap-2">
        <Checkbox
          checked={isSelected}
          onCheckedChange={(selected) => onSelect(id, !!selected)}
        />
      ...
      <ModalContent>
        <ModalHeader>
          <div className="flex flex-col gap-2.5">
            ...
            <p className="text-sm">
              Due to Assethub Migration, some of batch couldn&apos;t be used any
              more. You can migrate them to {destNetwork?.name}.
            </p>
          </div>
        </ModalHeader>
