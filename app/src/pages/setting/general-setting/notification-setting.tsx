...
function NotificationSetting({ address }: { address: string }) {
  ...
  if (!webPush.permission.isSupported) {
    return (
      <div className='flex flex-col gap-5'>
        <Alert>
          <AlertDescription>
            Web Push notifications are not supported in your browser. Please use a modern browser like Chrome, Firefox,
            Safari, or Edge.
          </AlertDescription>
        </Alert>
      </div>
