      ...
      <ModalContent>
        ...
        <ModalBody className="flex flex-col gap-[15px] py-0">
          ...
          <p className="text-foreground text-sm">
            The proxy is your everyday account. The Multisig stays in the
            background for security and is safe to hide.&nbsp;
            <a
          ...
          <div className="space-y-[5px]">
            ...
            <span className="text-foreground/50 text-xs">
              Hide from account list (can unhide in Settings anytime).
            </span>
          </div>
          <Divider className="bg-primary/5" />
        </ModalBody>
        ...
        <ModalFooter>
          <Button
            ...
            onClick={() => {
              ...
              service.account.updateAccountName(
                network,
                multisigAddress,
                multisigName,
              );
