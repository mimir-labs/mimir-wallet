    ...
    <>
      <Tooltip content="Copy Address">
        <CopyAddress
          address={address}
          color="primary"
          className="text-primary min-h-6 min-w-6 opacity-100"
        />
      </Tooltip>
        ...
        <ModalContent>
          ...
          <ModalBody>
            <p className="break-all">
              Are you sure you want to delete <b>{address}</b> from your Address
              Book?
            </p>
          </ModalBody>
          <Divider />
...
function AddressItem({ address }: { address: string }) {
  ...
  return (
    <>
      {!upSm && (
        <div className="card-root p-4 [&_.AddressCell-Address]:mt-2.5! [&_.AddressCell-Address]:text-sm [&_.AddressCell-Content]:ml-2.5 [&_.AddressCell-Name]:text-lg">
          <AddressCell
            iconSize={50}
            icons={<Icons address={address} />}
            shorten
            value={address}
            withCopy={false}
          />
      ...
      {upSm && (
        <div className="card-root relative flex items-center gap-10 p-6">
