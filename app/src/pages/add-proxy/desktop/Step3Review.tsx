  ...
  return (
    <div className="flex flex-col gap-4">
          ...
          {wizardData.isPureProxy ? (
            <div className="bg-secondary flex h-14 w-full items-center gap-2.5 rounded-[10px] px-2.5">
              ...
              <span className="text-foreground font-bold">
                {wizardData.pureProxyName || DEFAULT_PURE_ACCOUNT_NAME}
              </span>
            </div>
          ) : (
            <div className="bg-secondary w-full rounded-[10px] p-2.5">
          ...
          {remoteProxyChain && (
            <>
              ...
              <img
                ...
                className="h-5 w-5"
                alt={remoteProxyChain.name}
              />
              <span className="text-foreground text-sm">
                {remoteProxyChain.name}
              </span>
              <span className="text-foreground text-sm">
                due to remote proxy)
              </span>
      ...
      <div className="flex gap-2.5">
        ...
        >
          {safetyResult.isLoading || isTransactionLoading
            ? buttonSpinner
            : null}
          Confirm
        </Button>
      ...
      <SafetyWarningModal
        ...
        onConfirm={
          wizardData.isPureProxy ? handlePureSubmit : handleProxySubmit
        }
