...
function WalletConnectExample() {
  ...
  return (
    <>
      <div className="card-root flex w-full flex-col items-center justify-between gap-3 p-5 sm:flex-row">
        <div className="flex flex-1 items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-divider mt-1 text-xs">
              Connect to any other Dapp supports wallet connect. And also you
              can connect to Mimir.
            </p>
          </div>
        </div>
        <Button
