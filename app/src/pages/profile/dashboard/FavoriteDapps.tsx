...
function DappItem({
  removeFavorite,
  ...dapp
}: DappOption & { removeFavorite: (id: string | number) => void }) {
...
function FavoriteDapps() {
  ...
  if (favoriteDapps.length === 0) {
    return (
      <div className="card-root h-auto sm:p-5 lg:h-[210px]">
  ...
  return (
    <div className="group">
      <div className="card-root scroll-hover-show h-[210px] overflow-y-auto p-4 sm:p-5">
