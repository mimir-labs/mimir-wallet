...
function Hero({ address, totalUsd, changes }: { address: string; totalUsd: string | number; changes: number }) {
  ...
  return (
    <>
      <div className='rounded-large border-secondary bg-content1 shadow-medium flex h-[210px] w-full flex-col items-start justify-between gap-[5px] border-1 p-4 sm:p-5'>
